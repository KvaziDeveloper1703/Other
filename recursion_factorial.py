...
Правила:
+ Факториал определён только для неотрицательных целых чисел. Если n отрицательное, выбросить ValueError с сообщением: "Факториал определён только для неотрицательных чисел."
